...
export const FACTIONS:Record<FactionId,FactionDef>={
 ...
 melee:unit('orc-melee','Ironjaw','melee',70,25,175,14,3,1.4,1.8,1.15,36,'momentum','Armored front line. Sustained attacks build Fury, granting up to 30% damage and 15% attack speed.'),
