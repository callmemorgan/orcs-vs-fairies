...
export const FACTIONS:Record<FactionId,FactionDef>={
 ...
 melee:unit('automata-melee','Sentinel','melee',70,25,135,15,2,1.4,1.95,1.2,35,undefined,'A 45-point shield absorbs damage before ceramic armor takes harm. Shields recharge at 4/s after 6 seconds without damage.'),
 ranged:unit('automata-ranged','Prism Archer','ranged',85,40,75,19,0,7,2.1,1.6,42,undefined,'Crystal beams reach across the front line. Carries a 35-point rechargeable shield.'),
 special:unit('automata-special','Ward Engine','special',120,80,135,12,2,5,1.8,1.7,56,'ward','Q restores 24 shield to nearby friendly machines. Casts automatically when shields are damaged. 20s cooldown. Carries a 45-point shield.')},buildings:{
