...
export const FACTIONS:Record<FactionId,FactionDef>={
 ...
 melee:unit('orc-melee','Ironjaw','melee',70,25,175,16,3,1.4,1.8,1.15,36,'momentum','Armored front line. Sustained attacks build Fury, granting up to 30% damage and 15% attack speed.'),
 ...
 melee:unit('automata-melee','Sentinel','melee',70,25,135,15,2,1.4,1.95,1.2,35,undefined,'A 30-point shield absorbs damage before ceramic armor takes harm. Shields recharge at 4/s after 6 seconds without damage.'),
