...
export const FACTIONS:Record<FactionId,FactionDef>={
 ...
 melee:unit('orc-melee','Ironjaw','melee',70,25,175,16,3,1.4,1.8,1.15,36,'momentum','Armored front line. Sustained attacks build Fury, increasing damage.'),
 ...
 special:unit('orc-special','Wardrum','special',120,70,220,25,3,1.6,1.65,1.65,56,'momentum','Heavy shock infantry. Fury makes prolonged brawls devastating.')},buildings:{
 ...
 dwarves:{id:'dwarves',name:'Deepforge',subtitle:'Choose the ground. Hold it.',color:0xe7b551,accent:'#edc675',description:'Engineers prepare firing positions. Emplace your troops for protection and cannon range, then pack up to advance.',ai:{aggression:1.15,armySize:7,composition:{melee:.40,ranged:.35,special:.25}},units:{
 ...
 melee:unit('dwarf-melee','Shieldguard','melee',70,30,170,15,3,1.4,1.9,1.15,35,'entrench','Protect the gun line. Q emplaces: after 3 seconds, gain 3 armor and 25% damage. Movement packs up.'),
 ranged:unit('dwarf-ranged','Thunderlock','ranged',85,40,95,20,1,6.5,2,1.7,40,'entrench','Musket infantry. Q emplaces: after 3 seconds, gain 3 armor and 25% damage. Movement packs up.'),
 special:{...unit('dwarf-special','Siege Cannon','special',130,85,145,32,2,6,1.45,2.6,58,'entrench','Long-range artillery deals 80% bonus damage to buildings. Q emplaces: after 3 seconds, gain 3 range, 3 armor and 25% damage. Movement packs up.'),sight:11,buildingDamageMultiplier:1.8}},buildings:{
 ...
 melee:unit('undead-melee','Boneguard','melee',45,15,100,14,1,1.4,2.35,1,24,undefined,'Cheap, fragile infantry. Fallen mortal troops leave corpses for Gravecallers.'),
 ranged:unit('undead-ranged','Gravebow','ranged',65,30,70,17,0,6.5,2.25,1.4,32,undefined,'Brittle archers. Keep a screen of Boneguards between them and the enemy.'),
 special:unit('undead-special','Gravecaller','special',110,80,95,12,0,5.5,2.1,1.6,52,'raise','Automatically (or Q) consumes up to 2 corpses within 6 tiles, raising half-health Boneguards for 35 seconds. 22s cooldown. Raised troops use population and cannot be raised again.')},buildings:{
 ...
 tideborn:{id:'tideborn',name:'Tideborn',subtitle:'Follow the returning tide',color:0x57a7a3,accent:'#e2b897',description:'Amphibious defenders cross mud and shallows at full speed. Tidecallers heal their formation and send it forward in a surge.',ai:{aggression:1,armySize:9,composition:{melee:.45,ranged:.35,special:.20}},units:{
 ...
 melee:unit('tideborn-melee','Shellguard','melee',70,25,160,15,3,1.4,2.15,1.15,35,undefined,'Shell-armored infantry. Wet ground gives this steady formation a route around slower enemies.'),
 ranged:unit('tideborn-ranged','Harpooner','ranged',80,35,90,19,0,6.5,2.3,1.6,39,undefined,'Harpoons strike from behind the Shellguard line. Moves freely through mud and shallows.'),
 special:unit('tideborn-special','Tidecaller','special',110,75,115,11,1,5.5,2.2,1.6,54,'surge','Q restores 25 HP to nearby allies and grants 25% movement speed for 6 seconds. 24s cooldown. Casts automatically in combat.')},buildings:{
 ...
 worker:unit('automata-worker','Assembler','worker',50,0,55,4,0,1.3,2.15,1.4,12,undefined,'Gather wood, ore and crystal. Carries a 12-point rechargeable shield.'),
 melee:unit('automata-melee','Sentinel','melee',75,30,135,15,2,1.4,1.95,1.2,37,undefined,'A 30-point shield absorbs damage before ceramic armor takes harm. Shields recharge at 4/s after 6 seconds without damage.'),
 ranged:unit('automata-ranged','Prism Archer','ranged',85,40,75,19,0,7,2.1,1.6,42,undefined,'Crystal beams reach across the front line. Carries a 22-point rechargeable shield.'),
 special:unit('automata-special','Ward Engine','special',120,80,135,12,2,5,1.8,1.7,56,'ward','Q restores 24 shield to nearby friendly machines. Casts automatically when shields are damaged. 20s cooldown. Carries a 35-point shield.')},buildings:{
...
export const ABILITIES={
 surge:{name:'Returning Tide',description:'Restore 25 HP to allies within 5 tiles and grant 25% movement speed for 6 seconds.',cooldown:24},
