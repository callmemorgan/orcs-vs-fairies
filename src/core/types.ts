...
export type UpgradeId = 'worker-harvest' | 'worker-speed';
export interface Vec { x:number; y:number }
export interface Cost { wood:number; ore:number; crystal:number }
export interface UpgradeDef { id:UpgradeId; name:string; description:string; cost:Cost; researchTime:number; building:BuildingRole; appliesTo:UnitRole; effects:{gather?:number;speed?:number} }
